...
public class TrainsInfoController implements Initializable {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        fromtxt.setText("From: " + infoController.from);
        totxt.setText("To: " + infoController.to);
        datetxt.setText("Date: " + infoController.formattedDate);
    ...
    public void load() throws SQLException{
        String query1 = "select s_id from station where s_name='"+ infoController.from + "'";
        String query2 = "select s_id from station where s_name='"+ infoController.to + "'";
        ...
        String query = "select * from journey join train on journey.j_train=train.t_id join coach on coach.c_id=journey.j_coach where from_st=" + String.valueOf(station1) + " and to_st=" + String.valueOf(station2) + " and j_date='" + infoController.formattedDate + "'";
